...
<html lang="en" class="loading">
  ...
  <head>
    ...
    <link rel="apple-touch-icon" sizes="60x60" href="{{asset('/public/backend/app-assets/img/ico/apple-icon-60.png')}}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{asset('/public/backend/app-assets/img/ico/apple-icon-76.png')}}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{asset('/public/backend/app-assets/img/ico/apple-icon-120.png')}}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{asset('/public/backend/app-assets/img/ico/apple-icon-152.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('/public/backend/app-assets/img/ico/favicon.ico')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('/public/backend/app-assets/fonts/simple-line-icons/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/public/backend/app-assets/fonts/font-awesome/css/font-awesome.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/public/backend/app-assets/vendors/css/perfect-scrollbar.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/public/backend/app-assets/vendors/css/prism.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/public/backend/app-assets/vendors/css/chartist.min.css')}}">
    <!-- END VENDOR CSS-->
    <!-- BEGIN APEX CSS-->
  ...
  <body data-col="2-columns" class=" 2-columns ">
    ...
    <div class="wrapper">
      ...
      <div data-active-color="white" data-background-color="man-of-steel" data-image="{{asset('/public/backend/app-assets/img/sidebar-bg/01.jpg')}}" class="app-sidebar">
        <!-- main menu header-->
        <!-- Sidebar Header starts-->
        <div class="sidebar-header">
          <div class="logo clearfix"><a href="index.html" class="logo-text float-left">
              <div class="logo-img"><img src="{{asset('/public/backend/app-assets/img/logo.png')}}"/></div><span class="text align-middle">APEX</span></a><a id="sidebarToggle" href="javascript:;" class="nav-toggle d-none d-sm-none d-md-none d-lg-block"><i data-toggle="expanded" class="toggle-icon ft-toggle-right"></i></a><a id="sidebarClose" href="javascript:;" class="nav-close d-block d-md-block d-lg-none d-xl-none"><i class="ft-x"></i></a></div>
        </div>
        <!-- Sidebar Header Ends-->
        <!-- / main menu header-->
        <!-- main menu content-->
        <div class="sidebar-content">
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
                <li class="nav-item"><a href="{{URL::to('/dashboard')}}"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a></li>
                <li class="has-sub nav-item"><a href="#"><i class="ft-grid"></i><span data-i18n="" class="menu-title">Category Management</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1"></span></a>
                    <ul class="menu-content">
                        <li class=""><a href="{{URL::to('/add-category-product')}}" class="menu-item">Add category</a>
                        </li>
                        <li><a href="{{URL::to('/all-category-product')}}" class="menu-item">List category</a>
                        </li>
                    </ul>
                </li>
                <li class="has-sub nav-item"><a href="#"><i class="ft-copy"></i><span data-i18n="" class="menu-title">Brand Management</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1"></span></a>
                    <ul class="menu-content">
                        <li class=""><a href="{{URL::to('/add-brand-product')}}" class="menu-item">Add brand</a>
                        </li>
                        <li><a href="{{URL::to('/all-brand-product')}}" class="menu-item">List brand</a>
                        </li>
                    </ul>
                </li>

                <li class="has-sub nav-item"><a href="#"><i class="ft-layers"></i><span data-i18n="" class="menu-title">Product Management</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1"></span></a>
                    <ul class="menu-content">
                        <li class=""><a href="{{URL::to('/add-product')}}" class="menu-item">Add product</a>
                        </li>
                        <li><a href="{{URL::to('/all-product')}}" class="menu-item">List product</a>
                        </li>
                    </ul>
                </li>
                <li class="has-sub nav-item"><a href="#"><i class="ft-box"></i><span data-i18n="" class="menu-title">Order Management</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1"></span></a>
                    <ul class="menu-content">
                        <li><a href="{{URL::to('/all-order')}}" class="menu-item">List order</a>
                        </li>
                    </ul>
                </li>
              ...
              <ul class="navbar-nav">
                ...
                <li class="dropdown nav-item"><a id="dropdownBasic3" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-user font-medium-3 blue-grey darken-4"></i>
                  ...
                  <div ngbdropdownmenu="" aria-labelledby="dropdownBasic3" class="dropdown-menu text-left dropdown-menu-right"><a href="./chat.html" class="dropdown-item py-1"><i class="ft-message-square mr-2"></i><span>Chat</span></a><a href="./user-profile-page.html" class="dropdown-item py-1"><i class="ft-edit mr-2"></i><span>Edit Profile</span></a><a href="./inbox.html" class="dropdown-item py-1"><i class="ft-mail mr-2"></i><span>My Inbox</span></a>
                    <div class='dropdown-divider'></div><a href="{{URL::to('/logout-admin')}}" class='dropdown-item'><i class='ft-power mr-2'></i><span>Logout</span></a>
                  </div>
                </li>
    ...
    <div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-sm-none d-md-block"><a class="customizer-close"><i class="ft-x font-medium-3"></i></a><a id="rtl-icon" href="https://pixinvent.com/apex-angular-4-bootstrap-admin-template/html-demo-6/" target="_blank" class="bg-dark customizer-toggle"><span class="font-medium-1 white align-middle">RTL</span></a><a id="customizer-toggle-icon" class="customizer-toggle bg-danger"><i class="ft-settings font-medium-4 fa fa-spin white align-middle"></i></a>
      <div data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a" class="customizer-content p-3 ps-container ps-theme-dark">
        ...
        <div class="cz-bg-image row sb-bg-img">
          <div class="col-sm-2 mb-3"><img src="{{asset('/public/backend/app-assets/img/sidebar-bg/01.jpg')}}" width="90" class="rounded sb-bg-01"></div>
          <div class="col-sm-2 mb-3"><img src="{{asset('/public/backend/app-assets/img/sidebar-bg/02.jpg')}}" width="90" class="rounded sb-bg-02"></div>
          <div class="col-sm-2 mb-3"><img src="{{asset('/public/backend/app-assets/img/sidebar-bg/03.jpg')}}" width="90" class="rounded sb-bg-03"></div>
          <div class="col-sm-2 mb-3"><img src="{{asset('/public/backend/app-assets/img/sidebar-bg/04.jpg')}}" width="90" class="rounded sb-bg-04"></div>
          <div class="col-sm-2 mb-3"><img src="{{asset('/public/backend/app-assets/img/sidebar-bg/05.jpg')}}" width="90" class="rounded sb-bg-05"></div>
          <div class="col-sm-2 mb-3"><img src="{{asset('/public/backend/app-assets/img/sidebar-bg/06.jpg')}}" width="90" class="rounded sb-bg-06"></div>
        </div>
        ...
        <div class="tl-bg-img d-none">
          ...
          <div class="cz-tl-bg-image row">
            <div class="col-sm-3"><img src="{{asset('/public/backend/app-assets/img/gallery/bg-glass-1.jpg')}}" width="90" class="rounded bg-glass-1 selected"></div>
            <div class="col-sm-3"><img src="{{asset('/public/backend/app-assets/img/gallery/bg-glass-2.jpg')}}" width="90" class="rounded bg-glass-2"></div>
            <div class="col-sm-3"><img src="{{asset('/public/backend/app-assets/img/gallery/bg-glass-3.jpg')}}" width="90" class="rounded bg-glass-3"></div>
            <div class="col-sm-3"><img src="{{asset('/public/backend/app-assets/img/gallery/bg-glass-4.jpg')}}" width="90" class="rounded bg-glass-4"></div>
          </div>
        </div>
        <!-- Transparent BG Image Ends    -->
        <hr>
    ...
    <!-- BEGIN VENDOR JS-->
    <script src="{{asset('/public/backend/app-assets/vendors/js/core/jquery-3.2.1.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('/public/backend/app-assets/vendors/js/core/popper.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('/public/backend/app-assets/vendors/js/core/bootstrap.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('/public/backend/app-assets/vendors/js/perfect-scrollbar.jquery.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('/public/backend/app-assets/vendors/js/prism.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('/public/backend/app-assets/vendors/js/jquery.matchHeight-min.js')}}" type="text/javascript"></script>
    <script src="{{asset('/public/backend/app-assets/vendors/js/screenfull.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('/public/backend/app-assets/vendors/js/pace/pace.min.js')}}" type="text/javascript"></script>
    <!-- BEGIN VENDOR JS-->
    <!-- BEGIN PAGE VENDOR JS-->
    <script src="{{asset('/public/backend/app-assets/vendors/js/chartist.min.js')}}" type="text/javascript"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN APEX JS-->
    <script src="{{asset('/public/backend/app-assets/js/app-sidebar.js')}}" type="text/javascript"></script>
    <script src="{{asset('/public/backend/app-assets/js/notification-sidebar.js')}}" type="text/javascript"></script>
    <script src="{{asset('/public/backend/app-assets/js/customizer.js')}}" type="text/javascript"></script>
    <!-- END APEX JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="{{asset('/public/backend/app-assets/js/dashboard1.js')}}" type="text/javascript"></script>
    <script>
